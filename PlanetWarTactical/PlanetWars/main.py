...
if __name__ == '__main__':
    map_no = random.randrange(100)
    #map_directory = './maps/map' + str(map_no) + '.txt'
    map_directory = './maps/map66.txt'
    gamestate = open(map_directory).read()
    players = ['TacticalAI', 'AggressiveAI']
