...
class BoxWorldWindow(pyglet.window.Window):
    ...
    def __init__(self, filename, **kwargs):
        ...
        self.world.agent = Agent(self.world.start._vc, 20.0, self.world)
        ...
        self.search_types = ['position', 'item']
        self.search_type_idx = 0
    ...
    def add_handers(self):
        ...
        def on_key_press(symbol, modifiers):
            ...
            if symbol == key.H:
                self.world.agent.is_moving = not self.world.agent.is_moving
            elif symbol == key.G:
            ...
            # Change search mode? (Algorithm)
                ...
                self.search_type_idx += 1
                if self.search_type_idx > 1:
                    self.search_type_idx = 0
                self.plan_path()
    ...
    def plan_path(self):
        self.world.plan_path(search_modes[self.search_mode], self.search_types[self.search_type_idx], self.limit)
